module Agents
  class PostToFirebaseAgent < Agent
    cannot_create_events!

    default_schedule "never"

    description <<-MD
      A PostToFirebaseAgent receives events from other agents (or runs periodically), merges those events with the contents of `payload`, and sends the results as POST (or GET) requests to a specified url.
